  ...
  return (
    <div className="large:h-cards h-cards2 w-full gap-2 large:gap-0 border-sm border-coral overflow-hidden rounded-[10px] hover:scale-y-105 ease-in-out large:basis-1/2 bg-black">
      <div className="relative large:h-full h-96 group ">
        ...
        <div className="hidden group-hover:block group-hover: text-opacity-100 absolute z-100 left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 w-full text-eggshell overflow-hidden transition-all delay-300 font-bold large:h-cards h-cards2">
